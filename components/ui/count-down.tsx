...
export default function Countdown() {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-yellow-600 dark:bg-gray-900">
      {/* Timer box container */}
      <div className="bg-yellow-500 dark:bg-gray-800 shadow-lg rounded-lg p-8 w-full max-w-md">
        {/* Title of the countdown timer */}
        <h1 className="text-2xl font-bold mb-4 text-gray-800 dark:text-green-400 text-center">
          Countdown Timer
        </h1>
        ...
        <div className="flex items-center mb-6">
          <Input
            ...
            className="flex-1 mr-4 rounded-md border-green-400 dark:border-gray-600 dark:bg-green-400 dark:text-green-400"
          />
          <Button
            onClick={handleSetDuration}
            variant="outline"
            className="text-pink-800 dark:text-green-400"
          >
            Set
          </Button>
        </div>
        {/* Display the formatted time left */}
        <div className="text-6xl font-bold text-green-900 dark:text-green-900 mb-8 text-center">
          {formatTime(timeLeft)}
        </div>
        ...
        <div className="flex justify-center gap-4">
          <Button
            onClick={handleStart}
            variant="outline"
            className="text-green-900 dark:text-orange-500"
          >
          ...
          <Button
            onClick={handleReset}
            variant="outline"
            className="text-green-900 dark:text-blue-600"
          >
            Reset
          </Button>
        </div>
